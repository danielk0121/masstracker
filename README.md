...
<!-- 아래 경로에 스크린샷 추가 필요: doc/chart_height_issue.png -->
![차트 높이 이슈](doc/chart_height_issue.png)
...
<!-- 아래 경로에 스크린샷 추가 필요: doc/chart_scroll_issue.png -->
![차트 스크롤 이슈](doc/chart_scroll_issue.png)
...
- **최저/최고점만 항상 표시** — 나머지는 크로스헤어 터치로 확인
